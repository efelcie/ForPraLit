...
dann mit Merkmalen versehen. Für \thref{hyp:h2} bis \thref{hyp:h2.2}
...
sein. Für \thref{hyp:h2} modellieren wir wieder eine lineare Multiple
Regression, wobei das Geschlecht der Hauptfigur in
\emph{Dummy-Variablen} umkodiert werden muss. Für \thref{hyp:h2.1} bis
\thref{hyp:h2.3} berechnen wir eine Korrelation aus der jeweiligen
Dummy-Variable des Geschlechts der Hauptfigur und dem \emph{w/m-Faktor}
aus. Für \thref{hyp:h2.4} benötigen wir zwei Modelle die wir miteinander
...
Für \thref{hyp:h3} benötigen wir eine neues Merkmal, dass das Verhalten
...
sich die Zuordnung immer auf das Verhalten/Handeln der Hauptfigur.
...
Dummy-Variablen des Geschlechts der Hauptfigur mit eienr
