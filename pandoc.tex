...
\item[H4]
Geschichten in den \emph{innerer Monolog} vorkommt, werden eher von
Mädchen als von Buben.
\item[H5]
Geschichten in denen \emph{das Erwachsenwerden} Thema ist, wedern eher
von Mädchen als von Buben gelesen.
\end{description}
