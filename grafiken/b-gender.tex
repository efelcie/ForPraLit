% Created by tikzDevice version 0.6.2-92-0ad2792 on 2013-02-07 01:54:11
...
\path[fill=fillColor] (111.90, 69.52) circle (  2.13);

\path[fill=fillColor] (117.59,101.94) circle (  2.13);

\path[fill=fillColor] (128.99, 71.97) circle (  2.13);

\path[fill=fillColor] (128.99, 72.58) circle (  2.13);

\path[fill=fillColor] (140.38, 71.97) circle (  2.13);

\path[fill=fillColor] (163.17, 71.97) circle (  2.13);

\path[fill=fillColor] ( 77.71, 53.61) circle (  2.13);

\path[fill=fillColor] ( 94.81, 81.75) circle (  2.13);

\path[fill=fillColor] ( 94.81, 84.81) circle (  2.13);

\path[fill=fillColor] (174.57,109.29) circle (  2.13);

\path[fill=fillColor] ( 72.02, 76.86) circle (  2.13);

\path[fill=fillColor] (100.50, 49.94) circle (  2.13);

\path[fill=fillColor] (106.20, 81.14) circle (  2.13);

\path[fill=fillColor] (128.99, 86.04) circle (  2.13);

\path[fill=fillColor] (134.69,112.34) circle (  2.13);

\path[fill=fillColor] (134.69, 82.37) circle (  2.13);

\path[fill=fillColor] (163.17,107.45) circle (  2.13);

\path[fill=fillColor] (146.08, 81.14) circle (  2.13);

\path[fill=fillColor] (140.38,116.63) circle (  2.13);

\path[fill=fillColor] (140.38,111.73) circle (  2.13);

\path[fill=fillColor] (146.08, 55.45) circle (  2.13);

\path[fill=fillColor] (160.33,104.39) circle (  2.13);

\path[fill=fillColor] (163.17,114.79) circle (  2.13);
\end{scope}
\begin{scope}
\path[clip] (  0.00,  0.00) rectangle (216.81,180.67);
...
\node[text=drawColor,rotate= 90.00,anchor=base,inner sep=0pt, outer sep=0pt, scale=  1.20] at ( 17.30,101.33) {Buben};
\end{scope}
\end{tikzpicture}
